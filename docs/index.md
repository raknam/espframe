...
hero:
  name: Espframe
  text: for Immich
  tagline: A standalone digital photo frame that displays your Immich photo library on a 10" touchscreen — no hub, cloud, or extra software required.
  image:
    src: /immich-frame.png
    alt: Espframe displaying photos on a 10-inch touchscreen
  actions:
    - theme: brand
      text: Get Started
      link: /install
...
features:
  ...
  - title: Clock Overlay
    details: Displays the current time over your photos when enabled in settings.
  - title: Backlight Schedules
    details: Control brightness across day and night, with optional auto-off scheduling.
